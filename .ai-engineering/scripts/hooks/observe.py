...
def _handle_agent_dispatch(
    data: dict, project_root: Path, engine: str, session_id: str
) -> None:
...
if __name__ == "__main__":
    run_hook_safe(
        main, component="hook.observe", hook_kind="post-tool-use", script_path=__file__
    )
