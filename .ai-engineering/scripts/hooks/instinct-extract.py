...
def main() -> None:
    ...
    if is_debug_mode():
        ...
        with (
            ...
            open(debug_log, "a", encoding="utf-8") as f,
        ):
            f.write(
                f"[{timestamp}] instinct-extract: refreshed canonical instinct store\n"
            )


if __name__ == "__main__":
    run_hook_safe(
        main, component="hook.instinct-extract", hook_kind="stop", script_path=__file__
    )
